    ...
    <>
      ...
      <header style={{
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "0 1.5rem", height: "64px" }}>
          ...
          {/* Desktop CTA */}
          <div style={{ display: "flex", alignItems: "center", gap: "1.25rem" }} className="mkt-cta-desktop">
            <Link href="/login" style={{ color: "rgba(17,17,17,0.7)", fontWeight: 700, fontSize: "0.875rem", textDecoration: "none", fontFamily: "'Plus Jakarta Sans', sans-serif" }}>Login</Link>
            <Link href="/login" className="mkt-btn-primary">Get Started Free</Link>
          </div>
